...
Функціональна структура розробляється для КІСК виробництвом, та (за потреби) підсистеми керування. Вона створюється на основі вихідних даних, які є викладеними характеристиками об’єкту (все виробництво та ділянка основного відділення) та вимог до нього.  
...
У даному розділі кваліфікаційної роботи наводиться загальна концепція, тоді як деталізація за необхідності вказується в розділі 3.

#### Приклад функціональної структури КІСК 
...
#### Приклади функціональних структур для інтелектуальної системи керування

Нижче наводяться кілька прикладів функціональних структур для інтелектуальної системи керування та їх особливості. Детальніше ці приклади описані в [6].

- Інтегрована система автоматичного ситуаційного керування (рис.3)
- Інтелектуальна система автоматичного керування для реалізації прикладних функцій в умовах наявності випадкових зовнішніх збурень (рис.4)
- Інтелектуальна системи автоматичного керування на базі динамічної експертної системи (рис.5)
- Інтелектуальна система автоматичного керування із жорсткою логікою (рис.6)
- Інтелектуальна система автоматичного керування технологічним комплексом (рис.7) 

![img](media/lu34324xzf66_tmp_159285f1.jpg)

Рис.3. Функціональна структура інтегрованої інтелектуальної системи автоматичного ситуаційного керування

![img](media/lu34324xzf66_tmp_5538da85.jpg)

Рис.4. Функціональна структура інтелектуальної системи автоматичного керування для реалізації прикладних функцій в умовах наявності випадкових зовнішніх збурень

![img](file:///C:/Users/OLEKSA~1/AppData/Local/Temp/lu34324xzf5o.tmp/lu34324xzf66_tmp_7d97e104.jpg)

Рис.5. Функціональна структура інтелектуальної системи автоматичного керування на базі динамічної експертної системи

![img](media/lu34324xzf66_tmp_8e213dc0.jpg)

Рис.6.Функціональна структура інтелектуальної системи автоматичного керування із “жорсткою логікою”

![img](media/lu34324xzf66_tmp_fe5f06d5.jpg)

Рис. 7. Функціональна структура інтелектуальної системи автоматичного керування технологічним комплексом
...
Рис.8. Приклад структурної схеми КТЗ 
...
рис.9. Приклад фрагменту структурної схеми КТЗ з підсистемою IIoT
...
**Зверніть увагу, що в кваліфікаційній роботі потрібно виконувати тільки ті пункти, які стосуються теми кваліфікаційної роботи. Перелік рекомендованих пунктів наведено в розділі 5 даних методичних рекомендацій.** 
...
рис.10. Приклад відображення ієрархії обладнання (Equipment) в контексті виробничих потоків від рівня Site до рівня UNIT.
...
Автомати станів використовуються в роботі для опису функцій обладнання або процедур. Діаграми автомату станів можна виконувати у будь якому редакторі, якщо інше не обмежено в спеціальному завданні. Для тем що передбачають розроблення інтелектуальних систем рекомендується використовувати SysML або UML. 

На рис.14 показаний приклад означення автомату станів для процедури 
...
### Опис структури ЦД та її складових

У цьому розділі необхідно означити структуру цифрового двійника. Зокрема необхідно навести:

- функціональну структуру ЦД у довільному форматі (приклад рис.17)
- перелік та опис даних ЦД
- перелік та короткий опис моделей ЦД (моделі наводяться в окремому підрозділі)
- перелік та короткий опис сервісів цифрового двійника (реалізація сервісів наводиться в інших підрозділах)

Цифровий двійник (ЦД) у контексті даної роботи розглядається як комплексна модель об’єкта керування, що забезпечує відображення його поточного стану, прогнозування майбутньої динаміки та підтримку прийняття рішень. Структура ЦД включає три основні складові: дані, моделі та сервіси, які взаємодіють між собою в єдиному інформаційно-алгоритмічному середовищі (рис.17).

Підсистема даних забезпечує формування вхідної інформації, необхідної для роботи моделей цифрового двійника. Структура даних може передбачати наступні:

- поточні вимірювання технологічних параметрів, отримувані безпосередньо з PLC, датчиків та виконавчих механізмів;
- історичні ряди параметрів, що надходять із сервера архівів та баз даних систем SCADA/HMI;
- довідкові та паспортні параметри обладнання, які визначають конструктивні характеристики та обмеження об’єкта;
- збурювальні фактори, що можуть бути вимірюваними (наприклад, температура навколишнього середовища) або розраховуваними;
- згенеровані дані, які використовуються у випадку недостатності або відсутності реальних вимірювань. За потреби можуть застосовуватись методи статистичного синтезу, моделювання або програмної генерації даних для навчання моделей та перевірки їх адекватності.

Підсистема даних повинна забезпечувати цілісність, узгодженість і своєчасне оновлення інформації, що надходить у цифровий двійник.

Моделі є ядром цифрового двійника і забезпечують взаємозв’язок між вхідними даними, структурою об’єкта та його поведінковими характеристиками. У рамках цієї роботи модель цифрового двійника складається з таких компонентів:

- структурна модель, що відображає ієрархію обладнання, взаємозв’язки між його елементами та інформаційні інтерфейси відповідно до прийнятої декомпозиції об’єкта;
- поведінкова модель, яка описує динаміку процесу відповідно до вибраного типу моделювання (фізичного, статистичного або на основі машинного навчання);
- модель взаємодії з підсистемами керування, що означує формат обміну сигналами, доступ до внутрішніх параметрів, а також можливість впливу на керовані змінні.

Моделі цифрового двійника повинні відтворювати реальні властивості об’єкта з достатньою точністю, забезпечувати можливість прогнозування та бути придатними до інтеграції у контур прийняття рішень.

До сервісів цифрового двійника належать функціональні компоненти, що застосовують моделі та дані для вирішення прикладних задач керування. Приклад сервісів:

- сервіс оцінки поточного стану, який означує робочий режим, відхилення від нормальних умов, наявність ознак деградації або передаварійних тенденцій;
- сервіс прогнозування, що дозволяє оцінювати зміну параметрів у часі на основі моделі цифрового двійника;
- сервіс виявлення аномалій, який порівнює прогнозовані та фактичні дані та визначає ймовірні відхилення;
- сервіс оптимізації, що формує рекомендації або керувальні дії з метою мінімізації витрат, підвищення якості або енергоефективності;
- сервіс підтримки прийняття рішень, який узгоджує результати роботи інших сервісів і передає їх у систему керування або оператору.

Сервіси мають забезпечувати модульність, можливість розширення та сумісність з інформаційною структурою КІСК. 

Структурна побудова цифрового двійника передбачає ієрархічний обмін інформацією: дані формують вхідні потоки до моделей, моделі генерують оцінки та прогнози, а сервіси створюють керувальні або інформаційні дії на основі результатів моделювання. Така організація забезпечує узгодженість поведінки цифрового двійника з реальним об’єктом та дозволяє використовувати його в режимах моніторингу, прогнозування, аналізу та оптимізації.

У даному пункті наводяться тільки ті дані, моделі та сервіси які відносяться до теми кваліфікаційної роботи.

```mermaid
flowchart TD

  subgraph ICS [АСКТП]
     ICS_RT[Стан, дані з ПЧ]
     ICS_HIS[Історичні дані]
  end
    
  subgraph IIoT [Підсистема IIoT]
     IIoT_RT[Вібросигнали]
  end
subgraph DTw[ЦД]
  subgraph DATA[Шар даних]
    D_RT[(RT Буфер: вібрація, струм, швидкість, момент, режими)]
    D_HYS[(Сховище історичних даних)]
    D_LABELS[(Сховище міток)]
    D_META[(Паспортні дані обладнання, режими роботи)]
  end
  ...
  subgraph MODELS[Шар моделей]
    M_LRN[Модуль наавчання]
    M_CLF[ML-модель класифікації стану - норма/дефект]
    M_RUL[Модель оцінки залишкового ресурсу RUL]
  end
  D_META --> M_LRN 
  D_HYS --> M_LRN
  D_LABELS --> M_LRN
  ...
  subgraph SERVICES[Шар сервісів]
    S_STATE[Сервіс оцінки технічного стану обладнання]
    S_PRED[Сервіс прогнозу відмови / RUL]
    S_ALERT[Сервіс формування попереджень та рекомендацій]
  end
end
  D_RT --> S_STATE
  M_CLF --> S_STATE
  ...
  subgraph OUT[Системама обслуговування обладнання]
    CMMS[прогнози відмов]
  end
...
### Обґрунтування методів створення моделей для цифрового двійника
...
- аналіз вхідних/вихідних змінних та їх кореляцій
- 

рис.19.

### Алгоритми прийняття рішень на основі моделі ЦД

рис.20



### Означення вимог до інтелектуальних систем керування

У цьому пункті необхідно навести формалізовані вимоги до інтелектуальних систем керування. Зокрема необхідно навести:

- діаграму вимог на мові SysML або UML
- опис вимог (доповнення до діаграми)

На діаграмі вимог показуються лише функціональні вимоги ІСК та АСУ, що пов’язані з нею. На рис.21 показаний приклад діаграми вимог. Детально про означення вимог до інтелектуальних систем керування наведено в [6]

![img](media/lu34324xzf6g_tmp_c0d69c2c.jpg)

Рис.21. Приклад діаграми вимог

### Означення функцій користувачів 

У цьому пункті необхідно навести функції користувачів. Зокрема необхідно навести:

- Use Case diagram (приклад рис.22)
- опис функцій (доповнення до діаграми)

Детально про означення функцій користувачів наведено в [6]

![img](media/lu34324xzf6j_tmp_f686e97c.jpg)

Риc.22. Приклад фрагмента Use Case diagram

### Означення поведінки ІСК

У даному пункті необхідно описати поведінку інтелектуальної системи керування. Зокрема необхідно навести:

- діаграми діяльностей процесів (приклад рис.23)
- діаграма послідовності взаємодії підсистем (приклад рис.24)
- опис процесів (доповнення до діаграми)
- опис взаємодії підсистем (доповнення до діаграми)

Детально про означення поведінки ІСК наведено в [6]

![img](media/lu34324xzf6p_tmp_f433366f.jpg)

рис.23. Приклад діаграми діяльностей процесу 

![image-20251209113557838](media/image-20251209113557838.png)

рис.24. Приклад діаграми послідовності взаємодії підсистем 

### Модель системи та результати моделювання

У даному пункті необхідно описати модель замкнутої системи (об'єкт керування + система керування) та результати моделювання. Зокрема необхідно навести:

- параметричну модель об'єкту керування
- виведення моделі об'єкта керування та системи керування
- екранні копії та/або лістинги програм імітаційної моделі в середовищі моделювання (приклад рис.25)
- результати моделювання в динаміці об'єкта керування за каналами керування та збурення
- результати моделювання в динаміці експериментів з традиційними регуляторами (приклад рис.26)
- результати моделювання в динаміці експериментів з спеціальними регуляторами (відповідно до завдання) 

Приклади моделювання системи з різними типами регуляторів наведені в [6-8].



![image-20251209125500907](media/image-20251209125500907.png)

рис.25. Приклад екранної копії моделі в Simulink



![image-20251209125554098](media/image-20251209125554098.png)

рис.26. Приклад результатів моделювання в динаміці експериментів з традиційними регуляторами

### Лінгвістична апроксимація вхідних та вихідних змінних

Лінгвістична апроксимація вхідних та вихідних змінних наводиться в тих роботах, де використовується механізм нечіткого виведення. Зокрема необхідно навести:

- структуру нечіткої системи виведення (приклад рис.30)
- означення функцій належності (приклад рис.31)
- опис принципів лінгвістичної апроксимації

Детально про означення апроксимацію вхідних та вихідних змінних в кваліфікаційній роботі описано в [6]

![img](media/lu34324xzf6w_tmp_e56765b0.png)

Рис. 30. Означення структури нечіткої системи виведення

![img](media/lu34324xzf6w_tmp_721235e5.png)

Рис. 31. Означення функцій належності

### База правил для нечіткої системи

У даному пункті необхідно описати бази правил для нечіткої системи, де це передбачено темою роботи. Зокрема необхідно навести:

- означення правил нечіткого висновку (приклад рис.32)
- відображення роботи алгоритмів нечіткого висновку (приклад рис.33)
- відображення поверхонь відгуку (приклад рис.34)

Детально про означення правил для нечіткої системи та аналіз роботи системи в кваліфікаційній роботі описано в [6].

![img](media/lu34324xzf72_tmp_749d6339.png)

Рис. 32. Означення правил нечіткого висновку

![img](media/lu34324xzf72_tmp_63de4c50.png)

Рис. 33. Відображення роботи алгоритму нечіткого висновку

![img](media/lu34324xzf72_tmp_75d57412.png)

рис.34. Відображення поверхні відгуку 
...
Рис.25. Схеми підключень проводок промислових мереж
...
Опис інформаційного забезпечення рекомендується доповнювати таблицями або схемами, які розкривають інформаційну структуру КІСК виробництвом та АСКТП. У якості графічного представлення інформаційної структури можна використати схеми мережних інформаційних потоків (рис.26), або аналогічні. Схеми та таблиці, які відображають інформаційну структуру, можна розробляти окремо для кожної із мереж або для всієї системи. 

![image-20250511214806754](media/image-20250511214806754.png)

рис.26. Приклад схеми мережних інформаційних потоків
...
На рис.27 показана приклад схеми інформаційної структури зробленої в Mermaid.
...
рис.27.  Інформаційна структура підсистеми IIoT у вигляді схеми інформаційних потоків, побудована в Mermaid (приклад реалізації для вузла D2, D3, D4).

Крім схеми необхідно описати потоки та механізми взаємодії. Детально про це описано в [1]-[3].

### Означення майстерданих 

Майстердані варто розробляти у вигляді електронних таблиць. Приклад майстерданих в Google Sheet наведений [за посиланням](https://docs.google.com/spreadsheets/d/1GvttNOH74X2o9y0fh_qxQCHhfdFszx7m/edit). Приклад майстерданих наведений на рис.28. Рекомендації щодо заповнення наведені в роботах [1]-[3].

![image-20250517161037811](media/image-20250517161037811.png)

Рис.28. Приклад зовнішнього вигляду таблиці з майстерданими
...
### Компонування робототехнічного комплексу 

У даному пункті описується структура, елементи та взаємне розташування складових робототехнічного комплексу (РТК). Нижче наводиться приклад змісту та наповнення пункту.

- Призначення РТК: виконання операції нанесення клею на заготовку .
- Склад РТК:
  - Промисловий робот 6-осьовий (наприклад ABB IRB4600).
  - Робочий орган – пістолет для нанесення клею на заготовку.
  - Стіл кріплення деталей.
  - Контролер керування (наприклад ABB IRC5).
  - Блок живлення та шафа автоматизації.
  - Захисна огорожа з дверною групою та кінцевими вимикачами.
- Компонувальна схема:
  - Робот розташований праворуч від стола кріплення деталей.
  - Контролер змонтований у шафі керування.
  - Зона роботи позначена огорожею з дверцятами.

У розділ зазвичай додають схему компонування та креслення з розмірами.

### Програми для робота, які виконують поставлені завдання

У даному пункті описується програмне забезпечення для реалізації задачі, яка описується в розділі 3. 

Нижче наведений фрагмент програми для реалізації задачі що описується наступним алгоритмом (алгоритм задачі для робота повинен бути описаний в розділі 3):

- Робот переходить у стартову позицію.
- Оператор подає деталь та фіксує на столі.
- Робот перевіряє сигнали від системи безпеки для початку роботи.
- Робот отримує команду початку виконання нанесення клею на деталь.
- Повернення у стартову позицію.

Фрагмент програми (псевдокод)

```pseudocode
MODULE Module1

PERS tooldata Pen_TCP := [...];
PERS wobjdata Wobj_Box := [...];
------
PROC Path_Box()
   MoveJ Appr_Box, v500, fine, Pen_TCP\WObj:=Wobj_Box;
   MoveL pBox_10, v300, fine, Pen_TCP\WObj:=Wobj_Box;
   MoveL pBox_20, v300, fine, Pen_TCP\WObj:=Wobj_Box;
   MoveL pBox_30, v300, fine, Pen_TCP\WObj:=Wobj_Box;
   MoveL pBox_40, v300, fine, Pen_TCP\WObj:=Wobj_Box;
   MoveJ Appr_Box, v300, fine, Pen_TCP\WObj:=Wobj_Box;
ENDPROC
------
PROC Home()
   MoveJ HomePos, v1000, fine, Pen_TCP;
ENDPROC
------
PROC main()
   Home;
...
### Модель роботехнічного комплексу (за потреби)   

У даному пункті описують розроблену 3D-модель, цифровий двійник або симуляційну модель РТК. Приклад змісту:

Модель створено в програмному середовищі RobotStudio. Короткий опис моделі:  

- Відтворено геометрію робота, конвеєра та контейнерів.
- Налаштовано реальні параметри: швидкості, прискорення, вантажопідйомність.
- Проведено симуляцію циклу роботи.
- Результати: середній час циклу — 180 секунди; продуктивність — 12 деталей/год.

Модель використовується для:

- Перевірки досяжності позицій.
- Виявлення можливих колізій.
- Оптимізації траєкторій.

![img](file:///C:/Users/OLEKSA~1/AppData/Local/Temp/lu34324xzf5o.tmp/lu34324xzf5u_tmp_78b53d22.png)

рис.29. 3d модель тестування досяжності траєкторій та визначення колізій
